...
<div>
  ...
  <p>
    The fact that Vue Storefront packages are standalone allows to use them in <b>any Vue.js enviroment</b> so you're not forced to use Nuxt. You can use Vue Storefront packages with Vue CLI or even withing your custom Vue.js codebase.
  </p>
  <p>
